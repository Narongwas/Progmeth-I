...
public class TestLeaderUnitCard {
	...
	void testSetBuffHealth(){
		...
		leaderUnit1.setBuffHealth(6);
		assertEquals(6,leaderUnit1.getBuffHealth());
		leaderUnit3.setBuffHealth(-3);
		assertEquals(0,leaderUnit3.getBuffHealth());
	}
	...
	void testAttack() {
		...
		assertEquals(0,leaderUnit1.attackUnit(oppoUnit1));
		assertEquals(0,oppoUnit1.getHealth());
		oppoUnit1.setHealth(2);
		assertEquals(1,leaderUnit2.attackUnit(oppoUnit1));
		assertEquals(1,oppoUnit1.getHealth());
		assertEquals(1,leaderUnit2.attackUnit(oppoUnit1));
		assertEquals(0,oppoUnit1.getHealth());
		assertEquals(0,leaderUnit2.attackUnit(oppoUnit1));
		assertEquals(0,oppoUnit1.getHealth());
	}
	...
	void testBuffUnit() {
		...
		LeaderUnitCard leader2 = (LeaderUnitCard)leaderUnit2;
		
		leader2.buffUnit(unitList);
