...
public class TestVenomUnitCard {
	...
	void testAttack() {
		...
		oppoUnit1.setHealth(100000);
		assertEquals(100000,venomUnit2.attackUnit(oppoUnit1));
		assertEquals(0,oppoUnit1.getHealth());
		oppoUnit1.setHealth(999999999);
		assertEquals(999999999,venomUnit3.attackUnit(oppoUnit1));
		assertEquals(0,oppoUnit1.getHealth());
	}
}
